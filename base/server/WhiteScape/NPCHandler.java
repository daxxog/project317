...
public class NPCHandler {
		...
		for (int i = 0; i < maxNPCs; i++) {
			if (npcs[i] != null) {
				...
				if (npcs[i].IsDead == false) {
					if (npcs[i].npcType == 42 || npcs[i].npcType == 1762 || npcs[i].npcType == 1764) {
						if (npcs[i].actionTimer == 0) {//60000
					...
					} else if (npcs[i].npcType == 43 || npcs[i].npcType == 1763 || npcs[i].npcType == 1765) {
						if (misc.random2(50) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Baa!";
						}
					}
					...
					if (npcs[i].actionTimer == 0 && npcs[i].DeadApply == false && npcs[i].NeedRespawn == false) {
						...
						} else if (npcs[i].npcType == 1769 || npcs[i].npcType == 1770) {
							npcs[i].animNumber = 0x139; //goblin attack
						} else {
	...
	public void MonsterDropItems(int NPCID) {
		...
		if (ArrayID != -1) {
			int Total = GetTotalNPCDrops(ArrayID);
			if (Total > 0) {
				do {
					rnd = misc.random3((NpcDrops[ArrayID].Items.length - 1));
				} while (Total < rnd);
...
01 - Lumbridge cows
02 - North-West Lumbridge cows
03 - North Lumbridge-Draynor Village Route/house
04 - Lumbridge Sheeps
05 - Lumbridge Goblins
*/
...
/* 02 */			3196,3196,3197,3197,3193,3194,3193,3194,3201,3202,3206,3207,3209,3201,3202,3206,3207,3197,3198,3203,3204,3197,3198,3203,3204,3188,3189,3155,3188,3189,3191,3192,3193,3155,3172,3191,3192,3193,3198,3199,3172,3187,3188,3191,3192,3193,3198,3199,3187,3188,3154,3154,3194,3195,3194,3195,3197,3198,3199,3200,3201,3154,3163,3164,3180,3181,3194,3195,3197,3198,3198,3200,3201,3154,3163,3164,3180,3181,3184,3194,3195,3197,3198,3199,3163,3163,3178,3179,3191,3192,3193,3196,3197,3163,3164,3178,3179,3181,3182,3191,3192,3192,3196,3197,3181,3182,3155,3191,3192,3193,3157,3158,3160,3161,3157,3158,3160,3161,3168,3169,3157,3158,3159,3160,3168,3169,3157,3158,3159,3160,3182,3183,3182,3183,3165,3166,3165,3166,
/* 03 */		3167,3166,3167,3166,3168,3158,3158,3158,3158,3158,3158,3159,3157,3156,3155,3156,3154,3153,3152,3149,3158,3147,3146,3145,3144,3151,3150,3151,3150,3148,3147,3148,3147,3153,3153,3154,3155,3156,3157,3158,3159,3160,3161,3162,3163,3164,3164,3164,3163,3163,3164,3163,3164,3164,3170,3170,3169,3168,3168,3169,3169,3169,3170,/**/3186,3185,3191,3190,3187,3186,3185,/**/3188,3191,3192,3188,3192,3192,3188,3192,3188,3189,3190,3192,
/* 04 */			3212,3211,3209,3208,3206,3205,3204,3205,3207,3206,3207,3208,3205,3206,3205,3206,3206,3206,3204,3203,3203,3204,3211,3211,3193,3193,3194,3194,3193,3194,3194,3193,3213,3213,3213,3213,3213,3213,3213,3213,3213,3213,3213,3213,3212,3212,3212,3212,3212,3212,3211,3210,3209,3208,3207,3206,3205,3205,3204,3203,3202,3201,3200,3199,3198,3197,3196,3195,3194,3193,3192,3192,3192,3192,3192,3192,3192,3192,3192,3192,3192,3192,3192,3192,3192,3192,3191,3191,3192,3192,3193,3193,3194,3195,3196,3197,3198,3199,3200,3201,3202,3203,3204,3205,3206,3207,3208,3209,3210,3211,3212,3212,3111,
/* 05 */		3219,3219,3219,3220,3220,/**/3212,3213,3212,3213,3219,3222,3220,3212,3212,3215,3216,3216,3216,3117,3218,3219,3220,3221,3222,/**/
		},
		{
...
/* 02 */			3307,3308,3307,3308,3309,3309,3310,3310,3310,3310,3310,3310,3310,3311,3311,3311,3311,3313,3313,3313,3313,3314,3314,3314,3314,3315,3315,3316,3316,3316,3316,3316,3316,3317,3317,3317,3317,3317,3317,3317,3318,3318,3318,3318,3318,3318,3318,3318,3319,3319,3320,3321,3321,3321,3322,3322,3322,3322,3322,3322,3322,3323,3323,3323,3323,3323,3323,3323,3323,3323,3323,3323,3323,3324,3324,3324,3324,3324,3324,3324,3324,3324,3324,3324,3325,3325,3325,3325,3325,3325,3325,3325,3325,3326,3326,3326,3326,3326,3326,3326,3326,3326,3326,3326,3327,3327,3327,3327,3327,3327,3331,3331,3331,3311,3332,3332,3332,3332,3332,3332,3333,3333,3333,3333,3333,3333,3334,3334,3334,3334,3335,3335,3336,3336,3341,3341,3342,3342,
/* 03 */		3283,3283,3284,3284,3284,3283,3284,3285,3286,3287,3288,3285,3289,3290,3291,3291,3291,3291,3291,3291,3291,3291,3291,3291,3291,3292,3292,3293,3293,3293,3293,3294,3294,3297,3296,3295,3295,3295,3294,3293,3292,3291,3290,3290,3290,3290,3291,3292,3293,3293,3293,3294,3296,3297,3297,3296,3295,3294,3293,3292,3291,3290,3289,/**/3277,3276,3279,3279,3279,3279,3279,/**/3275,3275,3275,3273,3273,3272,3271,3271,3270,3270,3270,3270,
/* 04 */			3257,3257,3257,3257,3257,3257,3257,3258,3263,3264,3265,3264,3271,3271,3272,3272,3274,3275,3274,3274,3273,3273,3272,3271,3273,3274,3274,3273,3269,3269,3268,3268,3257,3258,3259,3260,3261,3262,3263,3264,3265,3266,3267,3268,3269,3270,3271,3272,3273,3274,3275,3276,3276,3276,3276,3276,3276,3277,3277,3277,3277,3277,3277,3277,3277,3277,3277,3277,3277,3277,3276,3275,3274,3273,3272,3271,3270,3269,3268,3267,3266,3265,3264,3263,3262,3261,3260,3259,3259,3258,3258,3256,3256,3256,3256,3256,3256,3256,3256,3256,3256,3256,3256,3256,3256,3256,3256,3256,3256,3256,3256,3260,3260,
/* 05 */		3264,3261,3260,3261,3260,/**/3275,3275,3276,3276,3275,3275,3277,3281,3282,3283,3282,3281,3280,3280,3279,3279,3278,3277,3276,/**/
		},
	};
			...
			if (npcs[NPCID].actionTimer == 0) {
				if (RingOfLife == true && EnemyHP <= (int)((double)((double)EnemyMaxHP / 10.0) + 0.5)) {
					...
					if (server.playerHandler.players[Player].IsDead == true) {
						...
						} else if (npcs[NPCID].npcType == 1769 || npcs[NPCID].npcType == 1770) {
							npcs[NPCID].animNumber = 0x135; //goblin attack
						} else {
	...
	public int GetTotalNPCDrops(int ArrayID) {
		int Total = 0;
		for (int i = 0; i < NpcDrops[ArrayID].Items.length; i++) {
			if (NpcDrops[ArrayID].Items[i] > -1) {
				Total++;
			}
		}
