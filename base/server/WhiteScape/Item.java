...
public class Item {
	...
	public static int platebody[] = {544,1035,540,5553,4757,1833,1835,6388,6384,2503,2501,2499,1355,4111,4101,4091,6186,6184,6180,3058,4509,4504,4069,4728,4736,4712,6107,2661,3140,1115,1117,1119,1121,1123,1125,1127,2583,2591,2599,2607,2615,2623,2653,2669,3481,4720,4728,4749,2661};
...
//			dagger			axe			mace			medium			sword			dart tips		nails				arrow heads		scimitar		long sword		full helmet		knives			square			warhammer		battle axe		chain			kite		claws				2-handed		skirt			legs			body				lantern/wire		studs
	...
	public static boolean[] itemStackable = new boolean[9000];
	public static boolean[] itemIsNote = new boolean[9000];
	public static boolean[] itemTwoHanded = new boolean[9000];
	public static boolean[] itemTradeable = new boolean[9000];
	public static boolean[] itemSellable = new boolean[9000];
	static {
		int counter = 0;
		int c;
		try {
